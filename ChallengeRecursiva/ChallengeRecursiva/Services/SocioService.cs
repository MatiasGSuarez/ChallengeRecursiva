...
namespace ChallengeRecursiva.Services
{
    public class SocioService
    {
        ...
        public async Task<object> Get100SociosAsync(Syncfusion.Blazor.DataManagerRequest dm)
        {
            try
            {
        ...
        public async Task<object> GetEstadisticasEquiposAsync(Syncfusion.Blazor.DataManagerRequest dm)
        {
